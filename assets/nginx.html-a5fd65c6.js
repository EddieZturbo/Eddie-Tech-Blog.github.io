import{_ as t,W as l,X as o,Z as n,a1 as s,$ as e,Y as i,G as c}from"./framework-3515e50f.js";const p="/Eddie-Tech-Blog.github.io/assets/image-20230108220502330.png",r="/Eddie-Tech-Blog.github.io/assets/image-20230108220603891.png",d="/Eddie-Tech-Blog.github.io/assets/image-20230108232749175.png",v="/Eddie-Tech-Blog.github.io/assets/image-20230108232809842.png",u="/Eddie-Tech-Blog.github.io/assets/image-20230129095354392.png",m="/Eddie-Tech-Blog.github.io/assets/image-20230108233047491.png",k="/Eddie-Tech-Blog.github.io/assets/image-20230108233229741.png",g="/Eddie-Tech-Blog.github.io/assets/image-20230108233321810.png",b="/Eddie-Tech-Blog.github.io/assets/image-20230129110830740.png",h="/Eddie-Tech-Blog.github.io/assets/image-20230108234753837.png",x={},w=n("h1",{id:"nginx",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nginx","aria-hidden":"true"},"#"),s(" Nginx")],-1),_=n("figure",null,[n("img",{src:p,alt:"image-20230108220502330",tabindex:"0",loading:"lazy"}),n("figcaption",null,"image-20230108220502330")],-1),y={href:"https://www.nginx.com/",target:"_blank",rel:"noopener noreferrer"},f=i('<figure><img src="'+r+`" alt="image-20230108220603891" tabindex="0" loading="lazy"><figcaption>image-20230108220603891</figcaption></figure><p><strong>——反向代理</strong></p><p><strong>——负载均衡</strong></p><p><strong>——HTTP服务器（动静分离）</strong></p><p><strong>——正向代理</strong></p><h2 id="linux安装nginx" tabindex="-1"><a class="header-anchor" href="#linux安装nginx" aria-hidden="true">#</a> Linux安装nginx</h2><blockquote><p><strong>在linux下安装nginx，首先需要安装 gcc-c++编译器。然后安装nginx依赖的pcre和zlib包。最后安装nginx即可。</strong></p></blockquote><p>1.先安装gcc-c++编译器</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> gcc-c++
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,16),z={href:"https://nginx.org/download/%EF%BC%89%EF%BC%8C%E4%B9%9F%E5%8F%AF%E4%BB%A5%E7%9B%B4%E6%8E%A5%E4%B8%8B%E8%BD%BD",target:"_blank",rel:"noopener noreferrer"},$=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://nginx.org/download/nginx-1.19.9.tar.gz
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+d+'" alt="image-20230108232749175" tabindex="0" loading="lazy"><figcaption>image-20230108232749175</figcaption></figure><figure><img src="'+v+'" alt="image-20230108232809842" tabindex="0" loading="lazy"><figcaption>image-20230108232809842</figcaption></figure><h2 id="nginx配置文件结构" tabindex="-1"><a class="header-anchor" href="#nginx配置文件结构" aria-hidden="true">#</a> Nginx配置文件结构</h2><figure><img src="'+u+'" alt="image-20230129095354392" tabindex="0" loading="lazy"><figcaption>image-20230129095354392</figcaption></figure><figure><img src="'+m+`" alt="image-20230108233047491" tabindex="0" loading="lazy"><figcaption>image-20230108233047491</figcaption></figure><ul><li>1、<strong>全局块</strong>：配置影响nginx全局的指令。一般有运行nginx服务器的用户组，nginx进程pid存放路径，日志存放路径，配置文件引入，允许生成worker process数等。</li><li>2、<strong>events块</strong>：配置影响nginx服务器或与用户的网络连接。有每个进程的最大连接数，选取哪种事件驱动模型处理连接请求，是否允许同时接受多个网路连接，开启多个网络连接序列化等。</li><li>3、<strong>http块</strong>：可以嵌套多个server，配置代理，缓存，日志定义等绝大多数功能和第三方模块的配置。如文件引入，mime-type定义，日志自定义，是否使用sendfile传输文件，连接超时时间，单连接请求数等。</li><li>4、<strong>server块</strong>：配置虚拟主机的相关参数，一个http中可以有多个server。</li><li>5、<strong>location块</strong>：配置请求的路由，以及各种页面的处理情况。</li></ul><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token comment">#user  nobody;</span>
...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="复杂配置" tabindex="-1"><a class="header-anchor" href="#复杂配置" aria-hidden="true">#</a> 复杂配置</h4>`,46),E={href:"http://www.zhengqing520.com/api",target:"_blank",rel:"noopener noreferrer"},T={href:"http://www.zhengqing520.com:9528/api/",target:"_blank",rel:"noopener noreferrer"},q={href:"http://www.zhengqing520.com/blog/",target:"_blank",rel:"noopener noreferrer"},N={href:"http://zhengqingya.gitee.io/blog/",target:"_blank",rel:"noopener noreferrer"},B=i(`<div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
    <span class="token directive"><span class="token keyword">listen</span>       <span class="token number">80</span></span><span class="token punctuation">;</span>
    <span class="token directive"><span class="token keyword">server_name</span>  www.zhengqing520.com</span><span class="token punctuation">;</span><span class="token comment"># 服务器地址或绑定域名</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="负载均衡" tabindex="-1"><a class="header-anchor" href="#负载均衡" aria-hidden="true">#</a> 负载均衡</h2><p>负载均衡也是Nginx常用的一个功能，负载均衡其意思就是分摊到多个操作单元上进行执行，例如Web服务器、FTP服务器、企业关键应用服务器和其它关键任务服务器等，从而共同完成工作任务。简单而言就是当有2台或以上服务器时，根据规则随机的将请求分发到指定的服务器上处理，<strong>负载均衡配置一般都需要同时配置反向代理，通过反向代理跳转到负载均衡</strong>。而Nginx目前支持自带3种负载均衡策略，还有2种常用的第三方策略。</p><figure><img src="`+h+'" alt="image-20230108234753837" tabindex="0" loading="lazy"><figcaption>image-20230108234753837</figcaption></figure><h3 id="负载均衡策略" tabindex="-1"><a class="header-anchor" href="#负载均衡策略" aria-hidden="true">#</a> 负载均衡策略</h3>',5),P=n("strong",null,"1) 轮询（默认）",-1),H={href:"https://www.cnblogs.com/spec-dog/p/13292111.html",target:"_blank",rel:"noopener noreferrer"},F=i(`<h3 id="负载均衡配置" tabindex="-1"><a class="header-anchor" href="#负载均衡配置" aria-hidden="true">#</a> 负载均衡配置</h3><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">upstream</span> cluster</span><span class="token punctuation">{</span><span class="token comment">#负载均衡配置 可以指定负载均衡规则</span>
    ...
    <span class="token punctuation">}</span>
        ...
        <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,10),I={href:"http://localhost",target:"_blank",rel:"noopener noreferrer"};function j(L,X){const a=c("ExternalLinkIcon");return l(),o("div",null,[w,_,n("p",null,[n("a",y,[s("https://www.nginx.com/"),e(a)])]),f,n("p",null,[s("2.在网上下nginx包上传至Linux（"),n("a",z,[s("https://nginx.org/download/），也可以直接下载"),e(a)])]),$,n("ol",null,[n("li",null,[n("a",E,[s("www.zhengqing520.com/api"),e(a)]),s(" 转发到 "),n("a",T,[s("http://www.zhengqing520.com:9528/api/"),e(a)])]),n("li",null,[n("a",q,[s("www.zhengqing520.com/blog/"),e(a)]),s(" 转发到 "),n("a",N,[s("http://zhengqingya.gitee.io/blog/"),e(a)])])]),B,n("p",null,[P,s(" 每个请求按时间顺序逐一分配到不同的后端服务器，如果后端服务器down掉，能自动剔除。 2)、weight 权重 指定轮询几率，weight和访问比率成正比，用于后端服务器性能不均的情况。 3)、ip_hash 每个请求按访问ip的hash结果分配，这样每个访客固定访问一个后端服务器，"),n("strong",null,[s("可以解决session的问题"),n("a",H,[s("nginx反向代理导致session失效的问题处理 - 【雨歌】 - 博客园 (cnblogs.com)"),e(a)])]),s("。 4)、fair（第三方） 按后端服务器的响应时间来分配请求，响应时间短的优先分配。 5)、url_hash（第三方）")]),F,n("p",null,[s("这样如果访问"),n("a",I,[s("http://localhost"),e(a)]),s(" 就会默认访问到E盘wwwroot目录下面的index.html，如果一个网站只是静态页面的话，那么就可以通过这种方式来实现部署。")])])}const C=t(x,[["render",j],["__file","nginx.html.vue"]]);export{C as default};
